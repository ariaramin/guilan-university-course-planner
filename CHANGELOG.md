...
## [1.1.0] - ۱۴۰۵/۰۶/۱۸ (2026-09-09)

### ✨ قابلیت‌ها
* ثبت دستی درس‌های گذرانده‌شده و استخراج محلی آن‌ها از «کارنامه ترمی ← دروس ترمی» سادا.
* تشخیص مجموع واحدهای نظری، عملی و کارگاهی و نادیده‌گرفتن نمره‌های کمتر از ۱۰.

### ⚡ بهبودها
* ساخت نقشهٔ تداخل کلاس و امتحان با پیمایش بازه‌ها، به‌جای بررسی تمام زوج‌های درس.
* بارگشایی غیرهم‌زمان تصویر نشان دانشگاه.
...
### 🌟 برجسته‌ترین تغییرات
* انتشار اولین نسخه متن‌باز افزونه **برنامه‌ریز انتخاب واحد دانشگاه گیلان**.
* توسعه مبتنی بر Chrome Extension (**Manifest V3**) با پردازش تمام‌محلی.

### ✨ قابلیت‌ها
* **استخراج دروس:** استخراج ایمن جدول دروس ارائه‌شده از سامانه سادا.
